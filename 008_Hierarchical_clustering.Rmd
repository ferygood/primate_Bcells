...
---
Load `twice` and other libraries.
...
Filter KZNFs and merge by rownames to keep all
```{r}
...
Next part is to visualize transposable elements
...
Next, we visualize and classified TEs based on class levels
```{r}
data(hg19rmsk_info)
...
Create transposable elements class lists to filter data
```{r}
...
teComplexHeatmap(
    ...
    speciesAnnot = c("Hs", "Hs", "Hs", "Pt", "Pt", "Pt", "Pa", "Pa", "Pa"),
